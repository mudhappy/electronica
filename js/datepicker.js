...
function getMonthYearString(dt) {
  return ['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio',
          'Agosto','Septiembre','Octubre','Noviembre','Diciembre'][dt.getMonth()] +
         ' ' + dt.getFullYear();
}
...
function createCalendar(div, month) {
  ...
  daysRow.insertCell(-1).innerHTML="Mie";
  daysRow.insertCell(-1).innerHTML="Jue";
  daysRow.insertCell(-1).innerHTML="Vie";
